...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	...
    	- 세션에 저장한 데이터는 브라우저 창이 종료될 때까지, 혹은
    	 세션의 유효시간이 만료되기 전까지
    	 웹 어플리케이션의 모든 jsp 파일에서 사용이 가능하다.
    	...
    	*/
    	...
    	// getAttribute의 리턴 타입은 Object이다.
    	// 강제 형변환을 통해 타입을 내려서 준비한 변수에 대입해야 한다.
    	...
    	//세션의 유효기간 설정
    	//세션의 수명을 따로 지정하지 않으면 기본 30분의 유효시간을 가진다.
