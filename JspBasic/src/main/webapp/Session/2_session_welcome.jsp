...
<body>
	...
	<%
	    ...
	    */
	    ...
	    if(session.getAttribute("user_id") == null){ //1번
	    	response.sendRedirect("2_session_login.jsp");
	    } else{
	...
	<h3>로그인 성공! <%=nick%>(<%=id%>)님 환영합니다!</h3> <!-- 2번 -->
	
	<a href="2_session_login.jsp">로그인 창으로 돌아가기</a> <br>
	<a href="../JspObjRequest/4_req_album.jsp">앨범 선택 페이지로 이동하기</a>
