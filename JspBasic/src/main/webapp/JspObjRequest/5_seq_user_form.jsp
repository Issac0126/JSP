...
<body>
	...
	<%-- 
		* 폼을 이용한 사용자의 입력값 서버로 전달하기
		- 사용자의 입력 데이터를 전송하려면 HTML의 form 태그를 사용한다.
		- form 태그의 action속성에 데이터를 전달받을 페이지의 url 주소를 작성한다.
		- input 태그의 name 속성으로 요청 파라미터의 이름을 지정할 수 있다.
		  이름을 지정할 때는 입력값과 관련있는 이름으로 지정해 주는 것이 좋다. 
	 --%>


	<form action="5_req_user_info.jsp">
